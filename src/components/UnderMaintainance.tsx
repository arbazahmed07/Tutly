...
export default function UnderMaintenance() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 pt-12">
      <Image unoptimized src='/maintenance.svg' className="block m-auto" width={500} height={500} alt="icon" />
      ...
      <Image unoptimized src='/under-construction.gif' className="absolute top-0 right-96" width={100} height={100} alt="icon" />
    </div>
  )
}
