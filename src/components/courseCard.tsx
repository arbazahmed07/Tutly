...
export default function CourseCard({ course, percent, classesCompleted }: any) {
    ...
    return (    
        <div hidden={!course.isPublished} key={course.id} onClick={() => router.push(`/courses/${course.id}`) } className="rounded-lg border cursor-pointer m-3 w-[320px]" style={{boxShadow: "rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px"}}>
