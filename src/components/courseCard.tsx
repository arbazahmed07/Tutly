...
export default function CourseCard({ course, percent, classesCompleted }: any) {
    ...
    return (
        <div key={course.id} onClick={() => router.push(`/courses/${course.id}`) } className="rounded-lg border cursor-pointer m-5" style={{boxShadow: "rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px"}}>
