...
export function StudentCards({ data, selectedCourse }: Props) {
  ...
  const groupedAssignments = course?.assignments?.reduce((acc, assignment) => {
  ...
  const filteredAssignments = selectedStatus === "All" 
    ? Object.entries(groupedAssignments || {}).flatMap(([status, assignments]) => assignments)
        ...
        <CardHeader className="flex flex-row items-center justify-between">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => setSelectedStatus("Submitted")}>Submitted</DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSelectedStatus("Not Submitted")}>Not Submitted</DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSelectedStatus("Not Evaluated")}>Not Evaluated</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
