...
export default async function Statistics() {
  ...
  const { classes, attendanceInEachClass } = await getAttendanceForMentorBarChart();
  const { assignments, countForEachAssignment }: any = await getSubmissionsForMentorLineChart();
