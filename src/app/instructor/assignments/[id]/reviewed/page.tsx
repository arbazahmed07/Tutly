...
return (
    ...
    {!coursesWithAssignments||coursesWithAssignments.length===0 ? <div className="text-center">No Assignments found!</div> : <AssignmentBoard reviewed ={true} courses={courses} assignments={coursesWithAssignments} userId={params.id} />}
    </div>
);
}
