      ...
      <h1 className="text-center mt-4 text-xl font-bold py-2">ASSIGNMENTS</h1>
      {
        courses===null||courses.length===0 ? <div className="text-center">No courses created yet!</div> :
          <Suspense fallback={<Loader />}>
            <div className="flex justify-end px-2"><Link href={"/instructor/assignments/getByAssignment"} className="text-sm text-secondary-500 font-semibold italic">Get by assignment?</Link></div>
