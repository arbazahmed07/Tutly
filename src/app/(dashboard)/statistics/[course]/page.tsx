import {
  ...
  export default async function Statistics({params}:any) {
    ...
    const { evaluated, underReview, unsubmitted, totalPoints}:any = await getStudentEvaluatedAssigments(params.course);
    ...
    const {classes,attendanceDates} = await getAttendanceOfStudent(currentUser.username,params.course);
