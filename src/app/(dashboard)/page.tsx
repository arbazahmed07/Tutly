  ...
  return (
    <div className="h-60 bg-primary-700">
        ...
        <div className="flex justify-around mt-2 text-center">
            <div className="w-80 rounded-sm shadow-xl p-2 bg-secondary-50 text-secondary-900">
            ...
            <div className="w-80 rounded-sm shadow-xl bg-secondary-50 text-secondary-900 p-2">
