...
const page = async ({
  ...
  const studentAccess = currentUser.role === 'STUDENT' && submission?.enrolledUser.username === currentUser.username;
  const mentorAccess = currentUser.role === 'MENTOR' && submission?.enrolledUser.mentorUsername === currentUser.username;
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <Playground currentUser={currentUser} assignmentId={assignmentId} initialFiles={initialFiles} />
    </Suspense>
  )
}
